...
export const metadata: Metadata = {
  title: 'Bald fuer dich da - Nermin Interiors',
  description:
  ...
  openGraph: {
    title: 'Nermin Interiors - Bald fuer dich da',
    description: 'Minimalistisches Interior Design fuer Menschen, die Klarheit und Qualitaet schaetzen.',
    url: BASE_URL,
